...
variable "public_nacl_in_tcp_ports_private_subnet" {
  type        = list(string)
  default     = ["80", "443", "22"]
}

variable "public_nacl_in_udp_ports_private_subnet" {
  type        = list(string)
  default     = []
}

variable "public_nacl_in_tcp_port_range_from_private_subnet" {
  type        = number
  default     = 1024
}

variable "public_nacl_in_tcp_port_range_to_private_subnet" {
  type        = number
  default     = 65535
}

variable "public_nacl_in_udp_port_range_from_private_subnet" {
  type        = number
  default     = 1024
}

variable "public_nacl_in_udp_port_range_to_private_subnet" {
  type        = number
  default     = 65535
}

variable "public_nacl_tcp_outbound_tcp_ports" {
  type        = list(string)
  default     = ["80", "443", "22"]
}

variable "public_nacl_tcp_outbound_udp_ports" {
  type        = list(string)
  default     = []
}


variable "public_nacl_out_tcp_port_range_from_private_subnet" {
  type        = number
  default     = 1024
}

variable "public_nacl_out_tcp_port_range_to_private_subnet" {
  type        = number
  default     = 65535
}


variable "public_nacl_out_udp_port_range_from_private_subnet" {
  type        = number
  default     = 1024
}

variable "public_nacl_out_udp_port_range_to_private_subnet" {
  type        = number
  default     = 65535
}